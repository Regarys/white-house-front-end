...
function AdminProposalBeasiswaInput () {
  ...
  return(
    <>
      <div className="admin-input-proposal">
        <div className="admin-input-proposal-inside">
          <h1>Input Proposal Beasiswa</h1>
          <form className="form-proposal" onSubmit={handleSubmit}>
            ...
            <div className="custom-input-proposal-alamat" style={{display: "flex"}}>
              <div>
                <h3>Alamat</h3>
                <input
                  type="text"
...
export default AdminProposalBeasiswaInput;
